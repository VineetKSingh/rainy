...
Or you can download the appropriate binary for your system from [the releases page](https://github.com/vineetksingh/rainy/releases).

Or if you're a [Gopher](https://blog.golang.org/gopher), you can `GO111MODULE=on go get github.com/vineetksingh/rainy/cmd/rain`
...
To contribute a change to Rain, just [fork this repository](https://github.com/vineetksingh/rainy/fork), make your changes, and submit a Pull Request.
